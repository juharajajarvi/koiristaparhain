var Library = {
    restrictToRange: function (value, minValue, maxValue) {
        if (value < minValue) {
            value = minValue;
    ...
    getStarImage: function (level) {
        ...
        for (var i = 0; i < 5; i++) {
            if (level <= i + 0.5) {
                content += "<img src='dog_app/img/0-star.png'>";
            } else if (level > i + 0.50 && level < i + 1.0) {
                content += "<img src='dog_app/img/0.5-star.png'>";
            } else if (level >= i + 1.0) {
                content += "<img src='dog_app/img/1-star.png'>";
            }
        }
